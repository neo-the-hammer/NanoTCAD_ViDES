/* Prevent C99 <complex.h> from overriding our custom complex type */
#define _Complex_I _Complex_I_UNUSED
#define complex _vides_complex_placeholder
#include "Python.h"
...
static PyObject* py_testing(PyObject* self, PyObject* args)
{
  ...
  temp_obj=PyLong_FromLong((long)N);
